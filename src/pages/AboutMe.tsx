...
export default function AboutMe() {
    return <div className="flex flex-row items-center justify-center gap-75 h-screen bg-grey-800 text-white px-20">
        ...
        <div className="w-full max-w-md">
            <form className="bg-stone-800 shadow-md rounded px-8 pt-6 pb-12 mb-10 gap-5">
